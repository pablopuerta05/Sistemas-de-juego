...
/// <summary>
/// replacement for the WeaponScriptableObject class. The idea is we want to store all weapon evolution data in one single object, instead of having multiple objects to store
/// a single weapon, which is what we would have had to do if we continued using WeaponScriptableObject.
/// </summary>
