...
public abstract class Item : MonoBehaviour
{
    ...
    public virtual ItemData.Evolution[] CanEvolve()
    {
        ...
        // Check each listed evolution and whether it is in inventory
    ...
    // AttempEvolution will spawn a new weapon for the character, and remove all the weapons that are supposed to be consumed.
    public virtual bool AttempEvolution(ItemData.Evolution evolutionData, int levelUpAmount = 1)
    {
        ...
        bool consumePassives = (evolutionData.consumes & ItemData.Evolution.Consuption.passives) > 0;
        bool consumeWeapons = (evolutionData.consumes & ItemData.Evolution.Consuption.weapons) > 0;
    ...
    public virtual bool DoLevelUp()
    {
        ...
        // tries to evolve into every listed evolution of this weapon, if the weapon's evolution condition is levelling up.
        foreach (ItemData.Evolution e in evolutionData)
        {
